...
public class PurgeFileWorker extends AbstractWorker implements IntFrameworkRunner {
  ...
  public PurgeFileWorker() {
    super("c-files-purge", Collections.singletonList(
        RunnerParameter.getInstance(INPUT_SOURCE_FILE, "Source file", Object.class, RunnerParameter.Level.REQUIRED,
            "FileVariable used to save")), Collections.singletonList(
        RunnerParameter.getInstance(OUTPUT_FILE_IS_PURGED, "File is purged", Object.class,
            RunnerParameter.Level.REQUIRED, "True if the file is purged correctly")), Collections.singletonList(
