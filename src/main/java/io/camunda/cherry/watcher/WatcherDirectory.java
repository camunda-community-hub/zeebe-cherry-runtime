...
@Component
public class WatcherDirectory extends AbstractWatcher {

  public static final String WATCHER_TYPE = "Directory";
  ...
  private final Logger logger = LoggerFactory.getLogger(WatcherDirectory.class.getName());
  private File archiveDirectory;

  public WatcherDirectory() {
  ...
  public String getDescription() {
    return "Watch a directory, and create one process instance per file in this directory";
  }
