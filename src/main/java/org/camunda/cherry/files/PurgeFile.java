...
@Component
public class PurgeFile extends AbstractWorker implements IntFrameworkRunner {
    ...
    public void execute(final JobClient client, final ActivatedJob activatedJob, ContextExecution contextExecution) {
        ...
        try {
            ...
            setValue(OUTPUT_FILE_IS_PURGED, filePurged, contextExecution);
        } catch (Exception e) {
            logError("Can't purge file " + e);
            setValue(OUTPUT_FILE_IS_PURGED, false, contextExecution);
