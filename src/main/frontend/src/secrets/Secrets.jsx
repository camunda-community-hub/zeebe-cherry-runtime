                    ...
                    <div className="row" style={{width: "100%"}}>
                        <div className="col-md-12">
                                ...
                                {this.state.secrets ? this.state.secrets.map((secret, _index) =>
                                    <tr style={this.getStyleRow(secret)}>
                                        <td style={{verticalAlign: "top"}}>
                                            ...
                                            {secret.error &&
                                                <div className="alert alert-danger"><ExclamationTriangle/>{secret.error}
                                                </div>}
                                        </td>
                                        <td>
                                            <Toggle
                            ...
                            <div className="alert alert-info" style={{margin: "10px 10px 10px 10px"}}>
                                When the toggle Secret is on, the value is stored on the server and is not accessible on
                                the portal. You
                                can change it:
