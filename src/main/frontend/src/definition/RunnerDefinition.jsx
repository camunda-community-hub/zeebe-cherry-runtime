                        ...
                        <table style={{width: "25rem", padding: "10px"}}>
                            <tr>
                                <td style={{verticalAlign: "top", padding: "10px"}}>
                                    <Card>
                                        <Card.Header
                                            style={{backgroundColor: "rgba(0,0,0,.03)"}}>{this.state.runner.name}</Card.Header>
                                        <Card.Body>
                                ...
                                <td style={{verticalAlign: "top", padding: "10px"}}>
                                    <Card>
                                        <Card.Header style={{backgroundColor: "rgba(0,0,0,.03)"}}>Element
                                        ...
                                        <Card.Body>
                                            ...
                                            <p class="card-text" style={{paddingLeft: "30px", paddingBottom: "20px"}}>
                                                <i>Copy the JSON in the
