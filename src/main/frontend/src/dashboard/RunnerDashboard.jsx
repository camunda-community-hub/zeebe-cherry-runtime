                  ...
                  <h1 className="title is-5 job-type is-hoverable">
                    <table>
                      ...
                      <tr>
                        <td>
                          <table
                            style={{border: "1px solid", padding: "5px", textAlign: "center", boxShadow: "5px 5px"}}>
                            <tr>
                              <td><img width="30px" src={this.state.runner.logo} alt={this.state.runner.name}/></td>
                            </tr>
                            <tr>
                        ...
                        <td style={{padding: "5px 0px 0px 25px"}}> {this.state.runner.name}
                          {this.state.runner.statistic && this.state.runner.statistic.executionsFailed > 0 &&
                            <Tag type="red" title="Fails"> {this.state.runner.statistic.executionsFailed} Fails </Tag>}
