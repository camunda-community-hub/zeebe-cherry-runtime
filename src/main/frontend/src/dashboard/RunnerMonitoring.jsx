                    ...
                    <Tab eventKey="graph" title="Graph">
                        <div className="container">
                            ...
                            <table style={{width: "100%"}}>
                                ...
                                <tr>
                                    <td style={{padding: "20px", maxHeight: "50px"}}>
                                        <RunnerChart type="DurationsAvg" runnerDisplay={this.state.runner}
                                                     title={true}/>
                                    </td>
                                    <td style={{padding: "20px", maxHeight: "50px"}}>
                                        <RunnerChart type="DurationsPic" runnerDisplay={this.state.runner}
                                                     title={true}/>
                                    </td>
                                </tr>
